...
# System Prompts configured to enforce direct persona without meta-bragging
...
class AIEngine:
    ...
    def ask(self, user_id: str, prompt: str, image=None) -> str:
        ...
        # Append historical messages (excluding previous system prompts)
        for msg in history:
    ...
    def _groq(self, messages, image=None):
        ...
        if image:
            # Override system prompt for vision
