...
# =========================================================
# EXISTING AI ENGINE CLASS - PRESERVED
# =========================================================
    ...
    def ask(self, user_id: str, prompt: str, image: Optional[Tuple[str, bytes]] = None) -> str:
        ...
        for provider in providers:
            try:
                ...
                continue
        return f"⚠️ AI temporarily unavailable. Last error: {last_error}" if last_error else "⚠️ AI unavailable - no provider configured."
