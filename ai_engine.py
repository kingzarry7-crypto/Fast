...
# =========================================================
# 💬 HUMAN CHAT STYLE (NEW) - makes normal conversation feel natural
# =========================================================
HUMAN_STYLE = """
...
def _is_casual_chat(text: str, has_image: bool = False, needs_web: bool = False) -> bool:
    """True for normal conversation (greetings, affection, venting, small talk).
    Trading, alerts, memory questions, images and web-search prompts use the full prompt."""
...
# NEW: only strip internal tool-style tags, so normal text like "<3" or "gold > 4300" survives
...
class AIEngine:
    ...
    def ask(self, user_id: str, prompt: str, image = None) -> str:
        ...
        # NEW: decide if this is normal chat (human style, lighter prompt) or a technical request
        needs_web = False
        try:
