...
class KingZarryAI(
    ...
    async def on_message(
        ...
        is_wake_word = (
            "king zarry" in content_lower
            or "kingzarry" in content_lower
            or mentioned
        )

        # Ignore normal messages that are not directed
        # at King Zarry AI.
        if not is_wake_word:
            return
        ...
        # User only said "King Zarry"
        if not clean_prompt:

            clean_prompt = (
                "Hello! Introduce yourself as "
                "King Zarry AI and ask how you can help."
            )

        print(
            f"🤖 AI PROCESSING: {clean_prompt!r}"
        )
...
async def start(
    ...
    await interaction.response.send_message(
        ...
        "💬 Say **King Zarry** followed by your question.\n"
...
async def help_command(
    ...
    await interaction.response.send_message(
        ...
        "💬 Say **King Zarry** + your question - AI chat\n"
