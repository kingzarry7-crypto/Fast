...
# Updated decommissioned model llama-3.2-11b-vision-preview -> llama-3.2-90b-vision-preview
...
def generate_elevenlabs_voice(text: str) -> io.BytesIO:
    ...
    try:
        ...
        # Consume generator completely within thread to prevent StopIteration leakage
