...
async def play_voice_in_channel(voice_client: discord.VoiceClient, text: str):
    ...
    try:
        # Run blocking ElevenLabs network request in an executor thread
        ...
        # Fallback to default speak function if ElevenLabs fails or runs out of quota
...
async def say(interaction: discord.Interaction, text: str):
    ...
    try:
        await play_voice_in_channel(voice, text)
