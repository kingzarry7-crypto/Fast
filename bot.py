...
# =========================================================
# KING ZARRY AI
# ALL-MESSAGE HUGGING FACE VERSION
# =========================================================
...
async def send_long_message(
    ...
    # Discord maximum is 2000 characters.
    # Keep chunks slightly below the limit.
    chunks = [
        text[i:i + 1900]
        for i in range(
            0,
...
def hf_request(messages):
    ...
    if not HF_TOKEN:
        ...
        raise RuntimeError(
            "HF_TOKEN is missing. "
            "Add HF_TOKEN to your environment variables."
        )
    ...
    # Some vision models return content as a list.
...
You should respond naturally to whatever the user asks.
...
explain the reasoning and risk.

Never pretend to have live market data unless
live data has actually been supplied.
...
class KingZarryAI(
    ...
    async def on_ready(self):
        ...
        print(
            "💬 ALL-MESSAGE AI CHAT IS ENABLED."
        )
    ...
    async def on_message(
        ...
        #
        # THE BOT RESPONDS TO EVERY NORMAL MESSAGE.
        # =================================================

        clean_prompt = content

        # Remove accidental bot mentions if present.
        if self.user:
...
async def start(
    ...
    await interaction.response.send_message(
        ...
        "💬 I respond to normal messages automatically.\n"
...
async def help_command(
    ...
    await interaction.response.send_message(
        ...
        "💬 Normal messages - AI responds automatically\n"
