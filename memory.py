...
def analyze_image_with_ai(image_bytes: bytes, mime_type: str, prompt: str) -> str:
    ...
    if GROK_API_KEY:
        try:
            return openai_compatible_request(vision_messages, GROK_API_KEY, GROK_BASE_URL, "qwen/qwen3.6-27b")
        except Exception:
            pass
...
async def on_message(message: discord.Message):
    ...
    async with message.channel.typing():
        try:
            ...
            # Split response into 2000 character chunks if needed (Discord message limit)
