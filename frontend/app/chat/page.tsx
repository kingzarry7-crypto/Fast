...
export default function KingZarryChatPage() {
  ...
  const [activeCapability, setActiveCapability] =
    useState<string | null>("REASONING");
  ...
  const handleSend = async (e?: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!userMsgText || coreState === "thinking") {
      return;
    }
    ...
    try {
      ...
      if (response.status === 401) {
        setMessages((prev) => [
          ...prev,
          {
            ...
            role: "ai",
            text: "Authentication required. Please sign in to continue using KING ZARRY AI.",
            timestamp: timeStr,
            status: "SECURITY MODULE • AUTHENTICATION REQUIRED",
            capability: "SECURITY",
          },
        ]);
      ...
      console.error("KING ZARRY AI chat error:", error);
      ...
      setMessages((prev) => [
        ...prev,
        {
          ...
          timestamp: timeStr,
          status: "AI CORE • CONNECTION ERROR",
          capability: "SYSTEM",
        },
      ]);
  ...
  return (
    <div className="relative w-full h-screen bg-[#03060a] text-cyan-100 font-sans overflow-hidden flex flex-col justify-between selection:bg-cyan-500 selection:text-black">
      ...
      {/* MOBILE MENU */}
      {mobileMenuOpen && (
        <div className="lg:hidden absolute top-[65px] inset-x-0 z-30 bg-[#040c16]/95 border-b border-cyan-500/30 p-4 backdrop-blur-xl">
          ...
          <div className="flex-1 overflow-y-auto px-4 py-6 space-y-6 scrollbar-thin scrollbar-thumb-cyan-500/20 scrollbar-track-transparent">
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-sm sm:text-base leading-relaxed tracking-wide font-sans">
                      {msg.text}
                    </p>
            ...
            {coreState === "thinking" && (
              <div className="flex items-center space-x-3 text-xs font-mono text-purple-300/80 bg-purple-950/20 border border-purple-500/30 p-3 rounded-lg w-fit animate-pulse">
                ...
                <span>
                  NEURAL CORE ANALYZING QUERY & SYNTHESIZING DATA...
                </span>
              </div>
            )}

            {connectionError && (
              <div className="text-[10px] font-mono text-red-400/80 px-2">
            ...
            {isVoiceActive ? (
              <div className="flex flex-col items-center justify-center p-4 rounded-xl border border-emerald-500/40 bg-emerald-950/20 shadow-[0_0_25px_rgba(16,185,129,0.15)] space-y-3">
                ...
                <div className="flex items-center space-x-3 text-emerald-400 font-mono text-xs tracking-widest">
                  ...
                  <span>
                    ACOUSTIC SPEECH RECOGNITION ACTIVE • LISTENING...
                  </span>
                </div>
                ...
                <div className="flex items-center space-x-4 pt-1">
                  ...
                  <button
                    onClick={() => {
                      setInput(
                        "Voice command captured and transmitted."
                      );
